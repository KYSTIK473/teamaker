...
class CustomStepper
{
  ...
  public:
    void disable();
    CustomStepper(PCF8574 & pcf, byte pin1, byte pin2, byte pin3, byte pin4, byte steps[] = (byte[]){8, B1000, B1100, B0100, B0110, B0010, B0011, B0001, B1001}, float spr = 4075.7728395, float rpm = 12, byte direction = CW);
